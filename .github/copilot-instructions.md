# Job Scheduler - Copilot Instructions

## Project Overview
A library providing scheduled job execution infrastructure for Spring Boot projects.
...
- **Key Libraries:**
  - Spring Data MongoDB for job state persistence
